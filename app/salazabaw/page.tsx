...
export default function SalaZabawPage() {
  return (
    /* ZMIANA: bg-transparent zamiast bg-white, aby widzieć Ribbons z layoutu */
    <main className="min-h-screen bg-transparent relative">
      
      {/* 🟢 WARSTWA 1: LOKALNE PARTICLES (Pływające kuleczki) */}
      ...
      {/* ⚪ WARSTWA 2: TREŚĆ (Szklane panele) */}
      <div className="relative z-10 w-full">
        
        {/* Sekcja główna z mapą i opisem (już poprawiona na transparent) */}
        <LeceWKulkiSection />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-20 space-y-6">
              ...
              <h2 className="text-6xl md:text-8xl font-black text-zinc-900 tracking-tighter leading-none uppercase italic">
                Zabawa, która <span className="text-[#BF2024] drop-shadow-[0_2px_10px_rgba(191,32,36,0.15)]">się opłaca</span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
              ...
              <div className="lg:col-span-7 relative group">
                ...
                >
                  ...
                  {/* SZKLANY KONTENER (Sandwich vibe) */}
                  <div className="relative md:absolute md:inset-8 z-20 flex-1 flex items-center justify-center p-4">
                    <div className="w-full max-w-2xl bg-white/50 rounded-[2.5rem] p-8 md:p-12 border border-white/30 shadow-2xl">
                      <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left mb-8">
                        ...
                        <div className="space-y-1">
                          ...
                          <h3 className="text-2xl md:text-3xl font-black text-zinc-900 italic leading-tight uppercase">Kupuj w urwisie, <br/>baw się w kulkach</h3>
                        </div>
                      </div>

                      <p className="text-zinc-900 text-lg font-bold leading-snug mb-10">
                        Za każde <span className="text-[#bf2024] font-black">10 zł</span> wydane w Sklepie Urwis dostajesz 1 Złotego Urwisa. Tutaj każdy punkt to <span className="font-black">1 zł zniżki</span> na dowolną przyjemność!
                      </p>
                      ...
                      <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <ArrowRight size={24} className="text-zinc-800 rotate-90 md:rotate-0" />
