  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6 px-2">
        ...
        <button onClick={onClose} aria-label="Zamknij misje" className="bg-zinc-50 p-2.5 rounded-full text-zinc-500 hover:bg-zinc-800 hover:text-white transition-colors cursor-pointer border border-zinc-200">
