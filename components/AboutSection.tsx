...
export default function AboutSection() {
  ...
  return (
    ...
    >
      {/* --- DEKORACYJNE POŚWIATY (Pod szkłem) --- */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        <motion.div
          animate={{ scale: [1, 1.1, 1], x: [0, 30, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
          className="absolute -top-20 -left-20 w-[500px] h-[500px] bg-red-200 rounded-full blur-[120px]"
        />
        <motion.div
          animate={{ scale: [1, 1.2, 1], x: [0, -40, 0] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute top-1/2 -right-20 w-[400px] h-[400px] bg-blue-200 rounded-full blur-[120px]"
        />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          <motion.h2
            ...
            className="text-5xl md:text-8xl font-black mb-8 font-heading tracking-tighter leading-none"
          >
            ...
            <span className="relative inline-block mt-2">
              ...
              <motion.div 
                ...
                className="absolute -bottom-2 left-0 h-3 bg-linear-to-r from-[#BF2024] to-[#0055ff] rounded-full opacity-30"
              />
            </span>
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-zinc-600 max-w-3xl mx-auto font-body font-bold leading-relaxed italic"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          {features.map((feature, idx) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="group relative bg-white/20 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/40 shadow-xl hover:bg-white/40 transition-all duration-300"
            >
              <div 
        ...
        >
          <div className="relative p-10 md:p-16 rounded-[4rem] bg-white/30 backdrop-blur-2xl border border-white/40 shadow-2xl overflow-hidden">
            ...
            {/* Blaski wewnątrz szkła */}
            <div className="absolute -top-20 -right-20 w-80 h-80 bg-[#BF2024]/10 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-[#0055ff]/10 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20 relative z-10">
              ...
              <div className="flex flex-col gap-5 w-full md:w-auto shrink-0">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative px-10 py-6 bg-zinc-900 text-white rounded-3xl font-black text-center shadow-2xl overflow-hidden flex items-center justify-center gap-3 tracking-widest text-sm uppercase italic"
                >
