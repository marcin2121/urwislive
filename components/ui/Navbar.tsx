      ...
      >
        ...
        <div className="w-full max-w-[1200px] bg-white/70 backdrop-blur-2xl border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.04)] rounded-full p-1 pr-4 flex items-center justify-between transition-all">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Link href="/salazabaw" className="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-linear-to-l from-[#ffc2d1] to-[#a2d2ff] opacity-100 hover:bg-blue-100/50 text-blue-600 border border-blue-100/50 rounded-full transition-all group backdrop-blur-sm">
            ...
            <Link href="https://akademiaurwisa.pl" target="_blank" className="relative overflow-hidden flex items-center gap-2 px-6 py-3 bg-zinc-900 text-white rounded-full shadow-lg shadow-blue-900/20 group hover:scale-105 transition-transform">
            ...
            <button onClick={() => setMobileMenuOpen(true)} className="xl:hidden p-3 rounded-full bg-zinc-100/50 hover:bg-zinc-200/50 text-zinc-600 transition-colors">
              <Menu size={22} />
            </button>
          </div>
        </div>
